...
@classmethod
def crear_usuario(cls, nombre, contraseña):
    hash_contraseña = generate_password_hash(contraseña, method='pbkdf2:sha256')
    nuevo_usuario = cls(nombre=nombre, contraseña=hash_contraseña)
...
def registro():
    if request.method == 'POST':
        ...
        Usuario.crear_usuario(nombre, contraseña)
        return redirect(url_for('login'))
